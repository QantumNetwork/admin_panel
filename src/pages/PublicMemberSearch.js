...
//   const userType = 'admin';
  ...
  return (
    <div className="dashboard-container">
      ...
      <div className="content-area" style={{marginLeft: '5%'}}>
      ...
      <div className="members-table-container" style={{ marginLeft: '5%' }}>
        {loading ? (
...
export default PublicMemberSearch;
